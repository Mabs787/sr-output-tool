...
async function captureRenderedSourceHtml(target, deps = {}) {
  ...
  const annotationScript = [
    ...
    "  .forEach((marker) => marker.remove());",
    "document",
    "  .querySelectorAll('[data-sr-rendered-viewport], [data-sr-computed-hidden], [data-sr-rendered-position], [data-sr-dom-node-id], [data-sr-marker-content], [data-sr-marker-display], [data-sr-marker-list-style-type], [data-sr-pseudo-before], [data-sr-pseudo-after], [data-sr-pseudo-before-layout-item], [data-sr-pseudo-after-layout-item]')",
    "  .forEach((element) => {",
    ...
    "    element.removeAttribute('data-sr-pseudo-before');",
    "    element.removeAttribute('data-sr-pseudo-after');",
    "    element.removeAttribute('data-sr-pseudo-before-layout-item');",
    "    element.removeAttribute('data-sr-pseudo-after-layout-item');",
    "  });",
    ...
    "    const pseudo = window.getComputedStyle(element, `::${side}`);",
    "    const hasPseudoContent = pseudo && pseudo.content !== 'none' && pseudo.content !== 'normal';",
    "    if (!hasPseudoContent || pseudo.display === 'none' || pseudo.display === 'contents' || pseudo.visibility === 'hidden' || pseudo.position === 'absolute' || pseudo.position === 'fixed') {",
    "      continue;",
    "    }",
    "    const pseudoContent = String(pseudo.content || '').replace(/^['\\\"]|['\\\"]$/g, '').trim();",
    "    if (pseudoContent) {",
    "      element.setAttribute(`data-sr-pseudo-${side}`, pseudoContent);",
    "    }",
    "    const collectionDisplay = /grid|flex/.test(style.display || '');",
    "    if (collectionDisplay && element.matches('ul, ol, [role=\"list\"], [role=\"grid\"]')) {",
    "      element.setAttribute(`data-sr-pseudo-${side}-layout-item`, 'true');",
    "    }",
    "  }",
    "}",
    "return JSON.stringify({",
...
async function captureStepSnapshot({
  ...
  const pageStateScript = [
    ...
    "      element.setAttribute(`data-sr-pseudo-${side}`, pseudoContent);",
    "    }",
    "    const collectionDisplay = /grid|flex/.test(elementStyle.display || '');",
    "    if (collectionDisplay && element.matches('ul, ol, [role=\"list\"], [role=\"grid\"]')) {",
    "      element.setAttribute(`data-sr-pseudo-${side}-layout-item`, 'true');",
    "    }",
    "  }",
    ...
    "  const keep = new Set(['id', 'role', 'aria-label', 'aria-labelledby', 'aria-describedby', 'aria-expanded', 'aria-hidden', 'hidden', 'href', 'type', 'title', 'alt', 'data-sr-dom-node-id', 'data-sr-marker-content', 'data-sr-marker-display', 'data-sr-marker-list-style-type', 'data-sr-pseudo-before', 'data-sr-pseudo-after', 'data-sr-pseudo-before-layout-item', 'data-sr-pseudo-after-layout-item']);",
