...
async function captureRenderedSourceHtml(target) {
  ...
  const annotationScript = [
    ...
    "  .forEach((marker) => marker.remove());",
    "document",
    "  .querySelectorAll('[data-sr-rendered-viewport], [data-sr-computed-hidden], [data-sr-rendered-position], [data-sr-dom-node-id], [data-sr-marker-content], [data-sr-marker-display], [data-sr-marker-list-style-type], [data-sr-pseudo-before-layout-item], [data-sr-pseudo-after-layout-item]')",
    "  .forEach((element) => {",
    ...
    "  }",
    "  if (element.matches('ul, ol, [role=\"list\"], [role=\"grid\"]')) {",
    ...
    "      if (collectionDisplay && hasPseudoContent && pseudo.display !== 'none' && pseudo.display !== 'contents' && pseudo.visibility !== 'hidden' && pseudo.position !== 'absolute' && pseudo.position !== 'fixed') {",
...
async function captureStepSnapshot({ target, stepIndex, announcement, focus }) {
  ...
  const pageStateScript = [
    ...
    "  const keep = new Set(['id', 'role', 'aria-label', 'aria-labelledby', 'aria-describedby', 'aria-expanded', 'aria-hidden', 'hidden', 'href', 'type', 'title', 'alt', 'data-sr-dom-node-id', 'data-sr-marker-content', 'data-sr-marker-display', 'data-sr-marker-list-style-type', 'data-sr-pseudo-before-layout-item', 'data-sr-pseudo-after-layout-item']);",
